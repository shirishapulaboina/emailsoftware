...
<tr><td class="myTextBox">Subject:</td><td><input type=text class="myTextBox" name=subject id=subject value="<%=subject%>" readonly></td></tr>
...
<tr><td></td><td><br><br><input type=submit value="Delete" class="myButton"></form><form name=f2 action=inbox.jsp><input type=submit value="Back" class="myButton"><br><br><a href="replyMail.jsp?mto=<%=mfrom%>&subject=<%=subject%>">REPLY</a>
</td></tr>
